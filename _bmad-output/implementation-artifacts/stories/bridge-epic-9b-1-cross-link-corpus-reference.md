...
- lesson-2026-05-20-007 (high): stories touching a class-A frozen test must carry this section AND re-register integrity for the touched test. Apply: the new `tests/scaffold/bridge-epic-9b-1-corpus-changelog-crosslink.test.mjs` is integrity-recorded as test-author; this section is populated from `tds memory query`.
...
- tests/scaffold/bridge-epic-9b-1-corpus-changelog-crosslink.test.mjs
