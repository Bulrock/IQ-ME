...
- [ ] **Task 2: restyle `landing.css`** — glass hero/CTA surface, prominent primary CTA, Light/Dark correct, entrance keyframes using motion tokens, reduced-motion no-op, mobile-correct. (impl phase)
